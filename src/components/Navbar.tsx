    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-purple-dark/90 backdrop-blur-md border-b border-brass-cmb/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-brass-cmb">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/register/dues-card" className="btn-brass px-4 py-2 rounded text-sm">
            Subscribe Today
          </Link>
        </div>
